...
var QualliSDK = /*#__PURE__*/function () {
  ...
  _createClass(QualliSDK, [{
    ...
    value: function _addPerson(person, showSurvey, isLarge, survey) {
      ...
      personVideo.playsInline = true; // Ensure the video is not played in fullscreen
      personVideo.controls = false; // Ensure the video controls are hidden
